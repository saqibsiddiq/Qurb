...
| [0006](0006-availability-gap.md) | Always-on node for offline availability | **Proposed — open** |
...
| [0011](0011-peer-identity-pinning.md) | Peer identity is a pinned certificate fingerprint | Accepted — pairing unbuilt |
